/* Documentazione di mterm: indice, ricerca, indice analitico, blocchi di codice, diagrammi.
...
(function () {
  ...
  function highlightTerminal(src) {
    return src.split("\n").map(function (line) {
      ...
      if (/^\s*✗|^mterm: /.test(line)) return '<span class="err">' + esc(line) + "</span>";
      return esc(line);
    }).join("\n");
  }
  ...
  function runSearch() {
    ...
    entries.forEach(function (e) {
      ...
      if (i < 0) return;
      var score = (t === q ? 0 : i === 0 ? 1 : 2) * 10 + ({ opzione: 0, comando: 0, tasto: 0, file: 1, capitolo: 2, sezione: 3, voce: 4 }[e.kind] || 5);
    ...
    letters.forEach(function (L) {
      ...
      groups[L].sort(function (a, b) { return a.text.toLowerCase().localeCompare(b.text.toLowerCase()); })
        .forEach(function (e) {
          ...
          if (e.kind === "opzione" || e.kind === "comando" || e.kind === "tasto" || e.kind === "file" || e.kind === "funzione") a.className = "mono";
          li.appendChild(a);
          var w = where(e.href);
